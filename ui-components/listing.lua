local function redraw_rows(state, column)
  ...
  for r=1, row_c do
    ...
    column:setAlignment(1, r, GUI.ALIGNMENT_HORIZONTAL_CENTER, GUI.ALIGNMENT_VERTICAL_CENTER)
    ...
    column:setAlignment(5, r, GUI.ALIGNMENT_HORIZONTAL_CENTER, GUI.ALIGNMENT_VERTICAL_CENTER)
